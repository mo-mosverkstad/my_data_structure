...
class Test_linked_list(unittest.TestCase):
    def setUp(self):
        ...
        self.assertTrue(self.__compare_list__([0,1,2]))

    def __compare_list__(self, expected_results):
    ...
    def test_get_set(self):
        ...
        self.assertTrue(self.__compare_list__([10,11,12]))

    def test_append(self):
        self.my_linked_list_obj.append(3)
        self.my_linked_list_obj.append(4)
        self.assertTrue(self.__compare_list__([0,1,2,3,4]))

    def test_insert(self):
        self.my_linked_list_obj.insert(2,12)
        self.assertTrue(self.__compare_list__([0,1,12,2]))

        self.my_linked_list_obj.insert(1,11)
        self.assertTrue(self.__compare_list__([0,11,1,12,2]))

        self.my_linked_list_obj.insert(0,10)
        self.assertTrue(self.__compare_list__([10,0,11,1,12,2]))

        self.my_linked_list_obj.insert(3,13)
        self.assertTrue(self.__compare_list__([10,0,11,13,1,12,2]))
    ...
    def test_delete(self):
        ...
        self.assertTrue(self.__compare_list__([0,2]))

        del self.my_linked_list_obj[1]
        self.assertTrue(self.__compare_list__([0]))

        del self.my_linked_list_obj[0]
        self.assertTrue(self.__compare_list__([]))
